...
const ja: Messages = {
  ...
  map_error: "地図を読み込めません。ネットワーク接続をご確認ください",
...
const en: Messages = {
  ...
  map_error: "Map failed to load; check your network connection",
...
const ko: Messages = {
  ...
  map_error: "지도를 불러올 수 없습니다. 네트워크 연결을 확인하세요",
  toggle_open: "☰ 필터 / 목록",
  toggle_close: "✕ 닫기",
  pop_dish: "고로의 한 끼",
  pop_address: "주소",
